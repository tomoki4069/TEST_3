...
class Application(tk.Frame):
    def __init__(self, master=None):
        ...
        self.Resistance_EditBox_1.insert(tk.END,"1234")
        ...
        self.calcButton = tk.Button(win, text=u'check',command= self.x)#ここにコマンドを追加する。それにより描画時以外でもボタン処理が可能
        #self.calcButton["command"] = self.x() # この処理だと描画した時だけ処理されるので別の方法で行う
    ...
    def Vol_Turn_Off(self):
        messagebox.askokcancel("Quit", "眠い？")
win = tk.Tk()
